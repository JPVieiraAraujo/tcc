...
/**
 * AreasCognitivasFixture
 */
class AreasCognitivasFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'nivel' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
