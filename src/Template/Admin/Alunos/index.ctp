<div class="d-flex">
    <div class="mr-auto p-2">
        <h2 class="display-4 titulo">Listar Alunos</h2>
    </div>
        <div class="p-2">
    ...
    <table class="table table-striped table-hover table-bordered">
        <thead>
            <tr>
                ...
                <th>Nome</th>
                <th>Turma</th>
                <th class="d-none d-sm-table-cell">Nome Responsável</th>
        ...
        <tbody>
            ...
            <tr>  
                ...
                <td><?= h($aluno->nome) ?></td>
                <td><?= h($aluno->turma->nome) ?>
                <td><?= h($aluno->nome_resp) ?></td>
                <td class="d-none d-lg-table-cell"><?= h($aluno->created) ?></td>
